...
int GameOver::Display(sf::RenderWindow &window, sf::View &view)
{
	//open main window
	//sf::Style::Fullscreen;
	//sf::RenderWindow window(sf::VideoMode(1512.0f, 1024.0f), "Main GameOver", sf::Style::Close | sf::Style::Resize);
	...
	backgroundTexture.loadFromFile("Backgrounds/game_over.png");
